...
Next safe gate: Stage 5 source-first multi-speaker diarization with a separate capability, disabled deployment and one bounded two-speaker acceptance; no widening of the single-speaker claim.
