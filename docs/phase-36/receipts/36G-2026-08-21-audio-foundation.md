...
- The immutable staged-tree snapshot (`1a364b2b4e046860c96ad9c55309a10aa5e71556`) passed root open-song/Audio/Phase36 contracts `78/78`; retained log SHA-256 `17682eb7904ec92bf351bbbb0b260498fdf28a1b459ab9a601946d02d3874ecc`.
...
- The same immutable snapshot passed complete Backend `978`, with one CI-only test skipped and no failure; retained authoritative log SHA-256 `2757bc1cd3f1509a2d03a42dea42ae1b78e77d7c0c9faf560ce4cb26f03668cb`.
- Alembic fresh upgrade and `0039 -> 0038 -> 0039` recovery passed with `audio_song_executions=0`, all Song/Media/Studio active counts `0`, PostgreSQL/Redis critical hits `0/0`, and every disposable container/network removed. Ruff, split Mypy for Core/Backend/isolated GPU package, Python AST across `23` files, `git diff --check`, and both Production Compose renders passed. Consolidated frozen pre-PR gate SHA-256: `a381571850e61671aafdf6680d8aa62e1d6763a7957d1c2e61d7c0ea06522270`.
...
## P36-0093 through P36-0096 — concurrent disposable/source drift was excluded truthfully
...
- **P36-0095:** a later live-mounted full-Backend run reported `978 passed, 1 skipped`, but three Stage 8 files changed while it was running. Its otherwise-green result is excluded because the source was not immutable. The final authoritative rerun used `git checkout-index` snapshot `1a364b2b4e046860c96ad9c55309a10aa5e71556`, not the mutable Worktree.
...
- Production, Provider state and user data were untouched throughout; additional Provider requests/GPU Jobs/spend caused by the harness corrections were `0 / 0 / $0.00`.
