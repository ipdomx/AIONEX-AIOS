...
FR-06C5D9B4C adds an actual read-only loopback allocation observer, pinned to Coturn image/container/process/network-namespace identity and bracketed by matching closed PostgreSQL authority reads. The source contract and real isolated CLI evidence are described in `docs/project/receipts/FR-06C5D9B4C-private-coturn-authority-integration.md`.
