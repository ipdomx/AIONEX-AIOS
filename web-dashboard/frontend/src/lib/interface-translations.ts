...
const AR: Catalog = {
  ...
  "Grant, deny, revoke, or scope real-person voice and face identity tools per user. Fictional/non-identical media remains directly available when its runtime is live.":
    "امنح أو امنع أو اسحب أو قيّد أدوات هوية الصوت والوجه للأشخاص الحقيقيين لكل مستخدم. تظل الوسائط الخيالية أو غير المطابقة متاحة مباشرة عندما يكون تشغيلها الحي متاحًا.",
  "Owner approval is an": "موافقة المالك هي",
  "AIOS application permission": "صلاحية داخل تطبيق AIOS",
  ...
  "User Identity Media permission denied immediately and audit-logged.":
    "تم منع صلاحية وسائط الهوية للمستخدم فورًا وتسجيل القرار في سجل التدقيق.",
  "Owner access update failed.": "فشل تحديث صلاحية المالك.",
  "Owner override removed. Real-person identity use now falls back to default deny.":
    "تمت إزالة تجاوز المالك. عاد استخدام هوية الشخص الحقيقي إلى المنع الافتراضي.",
  "Owner override removal failed.": "فشلت إزالة تجاوز المالك.",
  "Request review failed.": "فشلت مراجعة الطلب.",
  "Pending user requests": "طلبات المستخدمين المعلقة",
  "Grant / deny a user": "منح / منع مستخدم",
  "A deny overrides all default access for that operation. Clearing an override restores the default policy.":
    "قرار المنع يتجاوز كل صلاحيات الوصول الافتراضية لهذه العملية. إزالة التجاوز تعيد السياسة الافتراضية.",
  "Search users": "البحث عن المستخدمين",
  "Name, email, or user ID": "الاسم أو البريد الإلكتروني أو معرّف المستخدم",
  "Identity operation": "عملية الهوية",
  "Deny / block": "منع / حظر",
  ...
  "· subject:": "· الشخص:",
  "No pending Identity Media requests.": "لا توجد طلبات معلقة لوسائط الهوية.",
  "Current per-user overrides": "التجاوزات الحالية لكل مستخدم",
  "any verified subject": "أي شخص تم التحقق من حقوقه",
  "Remove override": "إزالة التجاوز",
  "No Owner overrides yet.": "لا توجد تجاوزات للمالك حتى الآن.",
  "Voice clone": "استنساخ الصوت",
  "Voice transformation": "تحويل الصوت",
  "Face reenactment": "إعادة تمثيل الوجه",
  "Face swap": "تبديل الوجه",
  "Talking head / avatar video": "فيديو أفاتار / وجه متحدث",
  "Lip sync": "مزامنة الشفاه",
  "Avatar generation": "إنشاء أفاتار",
  ...
  "Provider mode": "وضع المزود",
  "Owner override": "تجاوز المالك",
  "Default policy": "السياسة الافتراضية",
  "Eligible plans": "الخطط المؤهلة",
