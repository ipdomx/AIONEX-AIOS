...
def test_minimum_age_calculation_is_calendar_correct() -> None:
    assert _age_on(date(2000, 8, 1), date(2026, 7, 31)) == 25
    assert _age_on(date(2000, 7, 31), date(2026, 7, 31)) == 26


def test_real_device_signals_accept_supported_browser() -> None:
...
def test_real_device_signals_fail_closed_for_headless_browser() -> None:
