...
def test_backend_exposes_the_shipped_alembic_head() -> None:
    ...
    assert database.expected_alembic_heads() == frozenset({"20260919_0060"})


@pytest.mark.asyncio
@pytest.mark.parametrize("revision,accepted", [("20260917_0052", False), ("20260918_0053", False), ("20260918_0054", False), ("20260918_0055", False), ("20260918_0056", False), ("20260919_0057", False), ("20260919_0058", False), ("20260919_0059", False), ("20260919_0060", True)])
