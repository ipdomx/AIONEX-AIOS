...
from app.db.models import Notification, ProjectEvent, StudioExecution, StudioJob, StudioPublication, StudioSettlement, StudioPrestartCancellation, StudioPoststartCancellation, StudioSafetyReview
...
async def execution_case(studio_case, monkeypatch, tmp_path):
    case = studio_case
    extra = {Notification.__table__, StudioSafetyReview.__table__, ProjectEvent.__table__, StudioExecution.__table__, StudioPublication.__table__, StudioSettlement.__table__, StudioPrestartCancellation.__table__, StudioPoststartCancellation.__table__}
    while True:
