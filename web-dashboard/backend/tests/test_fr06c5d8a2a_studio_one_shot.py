...
from app.db.models import Notification, ProjectEvent, StudioJob, StudioSafetyReview
...
async def execution_case(studio_case, monkeypatch, tmp_path):
    case = studio_case
    extra = {Notification.__table__, StudioSafetyReview.__table__, ProjectEvent.__table__}
    while True:
