...
api_router.include_router(workflows.router, prefix="/workflows", tags=["Workflows"], dependencies=restricted)
api_router.include_router(servers.router, prefix="/infrastructure/servers", tags=["Servers"], dependencies=restricted)
api_router.include_router(containers.router, prefix="/infrastructure/containers", tags=["Containers"], dependencies=restricted)
api_router.include_router(databases.router, prefix="/infrastructure/databases", tags=["Databases"], dependencies=restricted)
...
api_router.include_router(backups.router, prefix="/backups", tags=["Backup and Recovery"], dependencies=restricted)
api_router.include_router(websocket.router, prefix="/realtime", tags=["Realtime"])
api_router.include_router(integration.router, prefix="/integration", tags=["AIOS Integration"], dependencies=restricted)
api_router.include_router(final_integration.router, prefix="/final-integration", tags=["Final Integration"], dependencies=restricted)
