...
class AudioTranscriptExecution(Base, TimestampMixin):
    __tablename__ = "audio_transcript_executions"
    __table_args__ = (
        UniqueConstraint(
            "organization_id",
            "idempotency_key",
        ...
        Index(
            "ix_audio_transcript_executions_provider_state_lookup",
            "provider",
            "provider_state",
        ),
    )
    ...
    idempotency_key: Mapped[str] = mapped_column(String(160), nullable=False)
    source_storage_backend: Mapped[str] = mapped_column(String(32), nullable=False)
    ...
    source_media_type: Mapped[str] = mapped_column(String(120), nullable=False)
    source_duration_ms: Mapped[int] = mapped_column(Integer, nullable=False)
    source_sample_rate_hz: Mapped[int] = mapped_column(Integer, nullable=False)
    source_channels: Mapped[int] = mapped_column(Integer, nullable=False)
    language: Mapped[str] = mapped_column(String(32), nullable=False)
    response_format: Mapped[str] = mapped_column(String(24), default="json", nullable=False)
    attempts: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    max_attempts: Mapped[int] = mapped_column(Integer, default=1, nullable=False)
    lease_token: Mapped[str | None] = mapped_column(String(36))
    lease_owner: Mapped[str | None] = mapped_column(String(160), index=True)
    ...
    output_checksum: Mapped[str | None] = mapped_column(String(64), index=True)
    output_size_bytes: Mapped[int | None] = mapped_column(BigInteger)
    transcript_checksum: Mapped[str | None] = mapped_column(String(64), index=True)
    transcript_text_sha256: Mapped[str | None] = mapped_column(String(64), index=True)
    transcript_characters: Mapped[int | None] = mapped_column(Integer)
