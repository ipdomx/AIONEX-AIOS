...
CAPABILITIES: Final[tuple[Phase36Capability, ...]] = (
    ...
    Phase36Capability("complete-stock-voice-dubbing", "audio", "Private translation, per-segment stock TTS, timing-fit alignment and final local master", "36G", "source_built", ("docs/phase-36/receipts/36G-2026-08-21-audio-foundation.md",), ("translation-and-segment-speech-runtime-evidence",)),
