...
CAPABILITIES: Final[tuple[Phase36Capability, ...]] = (
    ...
    Phase36Capability("multi-speaker-diarization", "audio", "Pseudonymous multi-speaker diarization with governed timed captions", "36G", "source_built", ("docs/phase-36/receipts/36G-2026-08-21-audio-foundation.md",), ("provider-diarization-runtime-evidence",)),
