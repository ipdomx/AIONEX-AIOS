...
CAPABILITIES: Final[tuple[Phase36Capability, ...]] = (
    ...
    Phase36Capability("lyria-3-music-generation", "audio", "Low-cost Lyria 3 Clip drafts and explicitly approved Pro full songs with governed local mastering", "36G", "source_built", ("docs/phase-36/receipts/36G-2026-08-21-audio-foundation.md",), ("valid-paid-gemini-credential", "lyria-preview-runtime-evidence", "music-rights-and-synthid-disclosure")),
