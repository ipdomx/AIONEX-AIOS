...
CAPABILITIES: Final[tuple[Phase36Capability, ...]] = (
    ...
    Phase36Capability("stable-audio-instrumental-generation", "audio", "Bounded Stability Stable Audio 2.5 instrumental drafts with governed local mastering", "36G", "source_built", ("docs/phase-36/receipts/36G-2026-08-21-audio-foundation.md",), ("funded-stability-credential", "stable-audio-2.5-runtime-evidence", "music-rights-and-ai-generated-disclosure")),
