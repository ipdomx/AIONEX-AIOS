...
CAPABILITIES: Final[tuple[Phase36Capability, ...]] = (
    ...
    Phase36Capability("professional-evidence-assistance", "healthcare", "Evidence-grounded professional assistance", "36K", "locally_executed", ("docs/phase-36/receipts/36K-2026-08-25-high-stakes-controls.md",), ("sector-evidence-and-human-review",)),
    Phase36Capability("high-stakes-human-review", "healthcare", "Human review and regulated-data controls", "36K", "locally_executed", ("docs/phase-36/receipts/36K-2026-08-25-high-stakes-controls.md",)),
